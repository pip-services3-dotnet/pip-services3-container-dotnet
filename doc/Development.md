# Development and Testing Guide <br/> Pip.Services Container for .NET
...
```bash
git clone git@github.com:pip-services3/pip-services3-container-dotnet.git
```
...
```bash
nuget pack PipServices3.Container.nuspec
```

Publish the package on nuget global repository

```bash
nuget push PipServices3.Container.XXX.nupkg -Source https://www.nuget.org/api/v2/package
```
